...
const Search = React.forwardRef<InputRef, SearchProps>((props, ref) => {
  ...
  if (isAntdButton || enterButtonAsElement.type === 'button') {
    ...
    button = (
      <Button
        ...
        type={enterButton ? 'primary' : 'secondary'}
        size={size}
        disabled={disabled}
        key="enterButton"
  ...
  const handleOnCompositionStart: React.CompositionEventHandler<
    HTMLInputElement
  > = (e) => {
